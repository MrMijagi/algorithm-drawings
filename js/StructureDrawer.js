...
class Connection {
  ...
  draw() {
    ...
    // draw arrows on ends
    if (this.end_arrow) {
      this.end_arrow_path = draw_arrow(this.path, this.path.segments.length - 1, this.path.length - this.arrow_offset, this.arrow_width, this.path_color);
    }

    if (this.start_arrow) {
      this.start_arrow_path = draw_arrow(this.path, 0, this.arrow_offset, this.arrow_width, this.path_color);
    }
